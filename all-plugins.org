...
C- good documentationategories:
-- good documentation- doing one thing well [X] color
-- good documentation- doing one thing well [X] compat   -- browser compatibility
-- good documentation- doing one thing well [X] fund     -- fundamental language functionality
-- good documentation- doing one thing well [ ] image
-- good documentation- doing one thing well [ ] layout
-- good documentation- doing one thing well [ ] meta     -- reporting / linting / minification
-- good documentation- doing one thing well [ ] mq       -- media queries
-- good documentation- doing one thing well [ ] prop     -- properties
-- good documentation- doing one thing well [ ] sel      -- selectors
-- doing one thing well [ ] text
